...
<Modal title="Manage Assignment Types" {onClose} width="560px" titleId="assign-types-title">
					...
					<div class="type-item" class:editing={editingId === type.id}>
						...
						{:else}
							...
							<div class="type-actions">
								<button class="btn btn-secondary btn-sm" onclick={() => startEdit(type)} title="Edit">
								...
								<button class="btn btn-danger btn-sm" onclick={() => handleRemove(type.id, type.name)} title="Remove">
									<svg viewBox="0 0 20 20" fill="currentColor" width="14" height="14">
										<path
											fill-rule="evenodd"
