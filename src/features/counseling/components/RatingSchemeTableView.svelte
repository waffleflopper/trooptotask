<script lang="ts">
	...
	import type { RatingSchemeEntry, RatingDueStatus } from '../counseling.types';
	import { RATING_STATUS_COLORS, WORKFLOW_STATUS_OPTIONS, WORKFLOW_STATUS_COLORS } from '../counseling.types';
	import { getRatingDueStatus, getDaysUntilDue, getReportTypeLabel } from '$features/counseling/utils/ratingScheme';
