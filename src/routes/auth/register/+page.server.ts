	...
	default: async ({ request, locals }) => {
		...
		if (newUser) {
			const { data: invitations } = await locals.supabase
				...
				.select('organization_id, can_view_calendar, can_edit_calendar, can_view_personnel, can_edit_personnel, can_view_training, can_edit_training, can_manage_members, scoped_group_id')
