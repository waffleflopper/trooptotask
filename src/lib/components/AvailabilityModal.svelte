...
<div class="modal-overlay availability-overlay" role="dialog" aria-modal="true" onclick={onClose} onkeydown={(e) => e.key === 'Escape' && onClose()}>
	<div class="modal availability-modal" onclick={(e) => e.stopPropagation()}>
