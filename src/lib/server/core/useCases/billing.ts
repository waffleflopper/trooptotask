...
export async function portal(ctx: UseCaseContext, input: PortalInput): Promise<{ url: string }> {
...
export async function cancel(ctx: UseCaseContext, input: CancelInput): Promise<CancelResult> {
