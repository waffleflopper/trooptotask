<script lang="ts">
	...
	import type { RatingSchemeEntry, WorkflowStatus } from '$features/counseling/counseling.types';
	import { RATING_STATUS_COLORS, WORKFLOW_STATUS_OPTIONS } from '$features/counseling/counseling.types';
	...
	import RatingSchemeGroupedView from '$features/counseling/components/RatingSchemeGroupedView.svelte';
	...
	import { exportRatingScheme } from '$features/counseling/utils/ratingSchemeExport';
